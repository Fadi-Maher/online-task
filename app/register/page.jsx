            ...
            {({ setFieldValue, errors, touched, resetForm }) => (
              <Form className="create-account-form">
                <div className="form-group mb-3">
                  ...
                  <Field placeholder="Enter your Full name" type="text" id="name" name="name" className="w-full p-2 mb-2 bg-gray-50" />
                ...
                <div className="form-group mb-3">
                  <label htmlFor="idImage" className="block mb-1">National ID Image</label>
                  <div className="relative">
                    <input 
                      id="idImage"
                      name="idImage"
                ...
                <div className="form-group mb-3">
                  <label>
                    <Field type="checkbox" name="termsAndConditions" className="mr-2 font-medium" />
